  ...
  return (
    <div className="meaning border-t border-gray-300 pt-4 mt-4">
        ...
        {meaning["antonyms"].length != 0 && (
            <div className="mt-3 text-graay-400 text-md">
                <span
                className="text-gray-200">
                    Antonyms:{"\u00A0"}</span>
        ...
        <ol className="flex flex-col gap-5 mt-3 text-gray-300 list-disc ml-5">
            ...
            ((value, key) => {
                return(
                    <li key={key}>
                        <div
                            className="text-md text-gray-300">{value["definition"]}
                        </div>
                        {value["example"] && (
                            <div
                            className="text-gray-200 mt-1 before:content-['-->] before:pr-2 before:text-red-500"
                            >
                            Example:{"\u00A0"}
